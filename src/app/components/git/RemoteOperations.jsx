            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                        <span className="text-gray-400 font-quicksand dark:text-gray-300 text-sm">Remote:</span>
                        <input
                            type="text"
                            name="remote"
                ...
                {inputValues.operation !== 'fetch' && (
                    <div className="space-y-2">
                        <div className="flex items-center space-x-2">
                            <span className="text-gray-400 font-quicksand dark:text-gray-300 text-sm">Branch:</span>
                            <input
                                type="text"
                                name="branch"
