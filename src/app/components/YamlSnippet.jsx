...
export default function YamlSnippet({ code, className = '', copyButton = true }) {
    ...
    return (
        <div className={`relative group ${className}`}>
            <pre className="bg-gray-900/80 p-4 rounded-lg border border-gray-700 overflow-x-auto text-sm">
                <code 
            ...
            {copyButton && (
                <button 
                    ...
                    className="absolute top-2 right-2 p-1.5 rounded bg-gray-800/80 hover:bg-gray-700/90 text-gray-300 hover:text-white transition-colors opacity-0 group-hover:opacity-100"
